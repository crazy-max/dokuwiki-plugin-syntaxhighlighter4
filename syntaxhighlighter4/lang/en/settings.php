...
// conf
$lang['autoLinks'] = 'Allows you to turn detection of links in the highlighted element on and off. If the option is turned off, URLs won\'t be clickable (Default true)';
$lang['firstLine'] = 'Allows you to change the first (starting) line number (Default 1)';
$lang['gutter'] = 'Allows you to turn gutter with line numbers on and off (Default true)';
